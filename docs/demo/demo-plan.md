...
| Infrastructure Headroom | "Top section: N-1 capacity, max deployable cells, vCPU ratio. These are your infrastructure constraints."                 |
| Current Utilization     | "Bottom section: memory, disk, staging capacity. This is your day-to-day utilization picture."                            |
