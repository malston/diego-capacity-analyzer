...
const ScenarioResults = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Infrastructure Headroom Section */}
      {(() => {
        const hasCpu =
          selectedResources.includes("cpu") && proposed.total_pcpus > 0;
        const infraCols = hasCpu ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1";
        return (
          <div
            ...
            <div className="space-y-6">
              ...
              <div className={`grid gap-6 ${infraCols}`}>
                ...
                {selectedResources.includes("cpu") &&
                  proposed.total_pcpus > 0 && (
                    <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700/50">
                      <div className="flex items-center gap-2 mb-4 text-gray-400">
                        <Cpu size={16} />
                        <Tooltip
                          text={TOOLTIPS.cpuRatio}
                          position="bottom"
                          showIcon
                        >
                          <span className="text-xs uppercase tracking-wider font-medium">
      ...
      {(() => {
        ...
        const utilGaugeCount = (hasMemory ? 1 : 0) + (hasDisk ? 1 : 0) + 1;
        const utilCols =
          utilGaugeCount >= 3
            ? "grid-cols-3"
            : utilGaugeCount === 2
